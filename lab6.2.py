...
model = BetterCNN(3, len(train_dataset.classes))  # Initialize model with same structure
model.load_state_dict(torch.load('/Users/jackhilton-jones/Deep_Learning/Lab6/bettercnn_model.pth'))
